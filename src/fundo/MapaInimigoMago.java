...
public class MapaInimigoMago extends JPanel implements ActionListener {
    ...
    private Image inimigoMagoImg1;
    private Image inimigoMagoImg2;
    private boolean alternarSprite = false;
    private int frameCount = 0;
    private final int trocarCada = 30;
    private int vidaInimigo = 300;
    private int vidaMaximaInimigo = 300;
    private double vidaAnimada = 300;
    ...
    public MapaInimigoMago( Hud hud, StatsMenu statsMenuController) {
        this.hud = hud;
        ...
        inimigoMagoImg1 = new ImageIcon("res/Oni1.png").getImage();
        inimigoMagoImg2 = new ImageIcon("res/Oni2.png").getImage();
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (tecla == KeyEvent.VK_ESCAPE) {
                    ...
                    Timer delay = new Timer(1500, evt -> trocarParaDojo());
    ...
    private void mostrarMensagensIniciais() {
        mensagensLog.clear();
        adicionarMensagemLog("Oni: HAHAHAHA");
        adicionarMensagemLog("Oni: Você ousa me desafiar sendo desse tamanho?");
        adicionarMensagemLog("Oni: Está preparado para morrer?");
    ...
    public void adicionarMensagemLog(String mensagem) {
        ...
        mensagensLog.add(mensagem);
            ...
            protected void paintComponent(Graphics g) {
                ...
                Image inimigoAtual = alternarSprite ? inimigoMagoImg1 : inimigoMagoImg2;
                ...
                g2.setFont(fontePixel);
                g.drawString("Inimigo: Oni", 50, 107);
            ...
            private void atacarInimigo() {
                int dano = (int) (Math.random() * 15 + 5); // entre 5 e 20
                diminuirVida(dano);
                if (vidaInimigo > 0) {
                    sofrerDanoDoInimigo();
                }
            ...
            public void diminuirVida(int dano) {
                ...
                if (vidaInimigo == 0) {
                    ...
                    Timer delay = new Timer(1500, e -> trocarParaDojo());
                    delay.setRepeats(false);
                    delay.start();
            ...
            private int calcularDanoInimigoContraPlayer() {
                int ataqueInimigo = 70;
                int defesaPlayer = player.getDefesa();
                int dano = ataqueInimigo - (defesaPlayer / 2);
                return Math.max(dano, 1); // nunca causa menos que 1
            }

            private void aumentarAtributosJogador() {
            player.setLevel(player.getLevel() + 1);
            player.setAtaque(player.getAtaque() + 10);
            player.setDefesa(player.getDefesa() + 10);
            player.setVidaMaxima(player.getVidaMaxima() + 100);
            player.setVida(player.getVidaMaxima());
