...
public class MapaInimigoArqueiro extends JPanel implements ActionListener {
    ...
    private Image inimigoArqueiroImg1;
    private Image inimigoArqueiroImg2;
    private boolean alternarSprite = false;
    private int frameCount = 0;
    private final int trocarCada = 30;
    private int vidaInimigo = 150;
    private int vidaMaximaInimigo = 150;
    private double vidaAnimada = 150;
    ...
    public MapaInimigoArqueiro( Hud hud, StatsMenu statsMenuController) {
        ...
        inimigoArqueiroImg1 = new ImageIcon("res/InimigoArqueiro1.png").getImage();
        inimigoArqueiroImg2 = new ImageIcon("res/InimigoArqueiro2.png").getImage();
    ...
    private void mostrarMensagensIniciais() {
        mensagensLog.clear();
        adicionarMensagemLog("! VOCê LOCALIZOU O BANDIDO !");
        adicionarMensagemLog("");
        adicionarMensagemLog("Bandido: Depois de te derrotar, pegarei todos seus pertences!");
        adicionarMensagemLog("");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setFont(fontePixel);
        g.drawString("Inimigo: Bandido", 50, 107);
    ...
    private void aumentarAtributosJogador() {
        ...
        player.setVidaMaxima(player.getVidaMaxima() + 40);
        player.setVida(player.getVidaMaxima());
